...
%cmake -DENABLE_OPENGL=ON -DENABLE_EGL=ON -DENABLE_BACKTRACE=ON -DENABLEX11=ON -DENABLE_WAYLAND=ON -DENABLE_LIBDECOR=ON -DENABLE_PIPEWIRE=ON -DENABLE_PULSEAUDIO=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5
%cmake_build
...
* Sat Jul 08 2023 Patrick Gaskin <patrick@pgaskin.net> - 0~B6-2
- Rebuild.
